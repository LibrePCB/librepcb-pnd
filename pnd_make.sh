...
echo -e
cecho "Creating an iso file based on '$FOLDER'." $white
if [ $SQUASH ];
then
...
# Append pxml to iso
echo -e
cecho "Appending '$PXML' to the created iso file." $white
...
then
	echo -e
	cecho "Appending the icon '$ICON' to the pnd." $white
...
if [ -f $PNDNAME ];
then
	cecho "Successfully finished creating the pnd '$PNDNAME'." $white
else
